...
public class NetworkMan : MonoBehaviour
{
    ...
    {
    //  passed into BeginReceive as a second parameter:
        UdpClient socket = result.AsyncState as UdpClient;
        
    // points towards whom sent the message:
        IPEndPoint source = new IPEndPoint(0, 0);

    // get message fill source:
    ...
    // Once reading is done, schedule next receive
    ...
    //Each player will get a different color
